              ...
              <div className="booking-content">
                <div className="client-info">
                  ...
                  <div className="client-details">
                    ...
                    <p>
                      <i className="fas fa-phone"></i> {booking.client.phone}
                    </p>
                    <p>
                ...
                <div className="service-info">
                  ...
                  <div className="service-details">
                    <p>
                      <i className="fas fa-paw"></i> <strong>Mascota:</strong>{" "}
                      {booking.service.pet}
                    </p>
                    <p>
                      <i className="fas fa-clock"></i> <strong>Fecha:</strong>{" "}
                      {booking.service.date}
                    </p>
                    <p>
                      <i className="fas fa-info-circle"></i>{" "}
                      <strong>Notas:</strong> {booking.service.notes}
                    </p>
                  </div>
                </div>
                ...
                <div className="booking-pricing">
                  <div className="price-breakdown">
                    {booking.pricing.map((price, index) => (
                      <div
                        key={index}
                        className={price.total ? "price-total" : "price-item"}
                      >
