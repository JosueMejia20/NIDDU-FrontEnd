...
const NewBooking = ({ navigateTo }) => {
  ...
  const servicios = [
    ...
    },
    {
      ...
      precio: 40000,
      imagen: 'https://images.unsplash.com/photo-1516734212186-a967f81ad0d7?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80',
      popular: false,
      duracion: '12 horas'
    }
  ];
    ...
    <section className="new-booking">
      <div className="container">
        <div className="booking-header">
          <button 
            className="back-btn"
            onClick={() => step > 1 ? setStep(step - 1) : navigateTo('dashboard')}
          >
          ...
          <div className="booking-step">
            ...
            <div className="services-grid">
              {servicios.map(servicio => (
                <div 
                  key={servicio.id} 
                  className={`service-card ${servicio.popular ? 'popular' : ''}`}
                ...
                >
                  ...
                  <div className="service-info">
                    ...
                    <div className="service-details">
                      ...
                      <span className="price">{formatPrice(servicio.precio)}</span>
                    </div>
                  </div>
                </div>
              ))}
